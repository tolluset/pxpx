/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: 6d24129b9e343ee3dcff3eaaed8f0714)
// Runtime types generated with workerd@1.20260301.1 2026-03-07 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/worker");
		durableNamespaces: "PixelRoom" | "GithubUserRegistry";
	}
	interface Env {
		ROOMS: DurableObjectNamespace<import("./cloudflare/worker").PixelRoom>;
		GITHUB_USERS: DurableObjectNamespace<import("./cloudflare/worker").GithubUserRegistry>;
	}
}
